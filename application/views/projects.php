            ...
            <div class = "body">
                ...
                <div class = "project_div">
                    ...
                    <div class = "project_images">
                        <a data-fancybox data-caption="CodeSonar bug statistics graph output." href = "<?php echo base_url('assets/images/cc26xx-web-demo-graph.png')?>" ><img src="<?php echo base_url('assets/images/cc26xx-web-demo-graph.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="CodeSonar code analysis of mqtt.c." href = "<?php echo base_url('assets/images/codesonar_output.png')?>" ><img src="<?php echo base_url('assets/images/codesonar_output.png')?>"  alt=""/></a>
                ...
                <div class = "project_div">
                    ...
                    <div class = "project_images">
                        <a data-fancybox data-caption="Brute forcer bot 3D modelled & printed, driven by an Arduino Uno." href = "<?php echo base_url('assets/images/brute_forcer.png')?>" ><img src="<?php echo base_url('assets/images/brute_forcer.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="Arduino code to run the brute forcer bot." href = "<?php echo base_url('assets/images/brute_forcer_code.png')?>" ><img src="<?php echo base_url('assets/images/brute_forcer_code.png')?>"  alt=""/></a>
                ...
                <div class = "project_div">
                    ...
                    <div class = "project_images">
                        ...
                        <a data-fancybox data-caption="Arduino code to run the clock." href = "<?php echo base_url('assets/images/clock_code.png')?>" ><img src="<?php echo base_url('assets/images/clock_code.png')?>"  alt=""/></a>
                ...
                <div class = "project_div">
                    ...
                    <div class = "project_images">
                        <a data-fancybox data-caption="Tweet feed for the Twitter weatherbot." href = "<?php echo base_url('assets/images/weatherbot_tweets.png')?>" ><img src="<?php echo base_url('assets/images/weatherbot_tweets.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="Arduino code to run the Twitter weatherbot." href = "<?php echo base_url('assets/images/weather_bot_python.png')?>" ><img src="<?php echo base_url('assets/images/weather_bot_python.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="Twitter profile." href = "<?php echo base_url('assets/images/canterbury_weatherbot.png')?>" ><img src="<?php echo base_url('assets/images/canterbury_weatherbot.png')?>"  alt=""/></a>
                    </div>
                    ...
                    <div class = "project_images">
                        <a data-fancybox data-caption="Email output of captured keystrokes, tested on my pc." href = "<?php echo base_url('assets/images/keylogger_output.png')?>" ><img src="<?php echo base_url('assets/images/keylogger_output.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="C++ code for the keylogger." href = "<?php echo base_url('assets/images/keylogger_code.png')?>" ><img src="<?php echo base_url('assets/images/keylogger_code.png')?>"  alt=""/></a>
                    </div>
                    ...
                    <div class = "project_images">
                        <a data-fancybox data-caption="Dragon fractal from Jurassic Park." href = "<?php echo base_url('assets/images/jp_dragon_fractal.png')?>" ><img src="<?php echo base_url('assets/images/jp_dragon_fractal.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="Serpinski arrowhead fractal." href = "<?php echo base_url('assets/images/serpinski_arrow.png')?>" ><img src="<?php echo base_url('assets/images/serpinski_arrow.png')?>"  alt=""/></a>
                        <a data-fancybox data-caption="Game of Life cellular automata simulation." href = "<?php echo base_url('assets/images/gol.png')?>" ><img src="<?php echo base_url('assets/images/gol.png')?>"  alt=""/></a>
                    </div>
                </div>
            </div>
        </div>
